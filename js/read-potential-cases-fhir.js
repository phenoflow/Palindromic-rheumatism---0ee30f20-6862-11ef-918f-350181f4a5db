...
(async () => {
  ...
  await fs.writeFile("palindromic-rheumatism-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("palindromic-rheumatism-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
